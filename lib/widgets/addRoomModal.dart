...
// import 'package:powerdown_frontend/widgets/confirmationModal.dart'; // Import the ConfirmationModal
// import 'package:provider/provider.dart';

// class AddRoomModal extends StatefulWidget {
//   final void Function(String) onRoomSelected;

//   const AddRoomModal({Key? key, required this.onRoomSelected}) : super(key: key);
...
//                 });
//                 Navigator.pop(context); // Close the AddRoomModal

//                 // Navigate to AddDeviceModal
//                 Navigator.push(
//                   context,
//                   MaterialPageRoute(
//                     builder: (context) => AddDeviceModal(
//                       selectedRoom: _pendingRoom,
//                       onDeviceAdded: (deviceName) {
//                         // Navigate to ConfirmationModal
//                         Navigator.push(
//                           context,
//                           MaterialPageRoute(
...
//                                 room.addRoom(roomName, ''); // Add the room when done is pressed
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                widget.onRoomSelected(_pendingRoom);
